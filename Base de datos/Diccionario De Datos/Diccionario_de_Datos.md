...
![Ejercicio 1 ER](img/Ejercicio1.png)

**Modelo Relacional**

![Ejercicio 1 Relacional](img/Ejercicio1ModeloRelacional.png)
...
![Ejercicio 2 ER](img/Ejercicio2.png)

**Modelo Relacional**

![Ejercicio 2 Relacional](img/Ejercicio2ModeloRelacional.png)
...
5. De cada inscripción se desea almacenar: fecha de inscripción y calificación final.
...
![Ejercicio 3 ER](img/Ejercicio3.png)

**Modelo Relacional**

![Ejercicio 3 Relacional](img/Ejercicio3ModeloRelacional.png)
...
![Ejercicio 4 ER](img/Ejercicio4.png)

**Modelo Relacional**

![Ejercicio 4 Relacional](img/Ejercicio4ModeloRelacional.png)
...
Una empresa necesita administrar su estructura organizacional.
...
1. Un empleado administra un único departamento.
2. Un departamento tiene un único gerente.
3. Un departamento puede tener varias ubicaciones.
4. Un departamento administra varios proyectos.
5. Un empleado puede participar en varios proyectos.
6. Un empleado puede tener varios dependientes.
...
![Ejercicio 5 ER](img/Ejercicio5.png)

**Modelo Relacional**

![Ejercicio 5 Relacional](img/Ejercicio5ModeloRelacional.png)
...
Una empresa necesita administrar empleados, departamentos, ubicaciones y proyectos.
...
1. Un departamento tiene un único gerente.
2. Un empleado puede participar en varios proyectos.
3. Un empleado puede registrar varios dependientes.
4. Un proyecto pertenece únicamente a un departamento.
...
![Ejercicio 6 ER](img/Ejercicio6.png)

**Modelo Relacional**

![Ejercicio 6 Relacional](img/Ejercicio6ModeloRelacional.png)
...
Una universidad necesita administrar alumnos, profesores, materias, departamentos, proyectos y credenciales.
...
1. Cada alumno posee una única credencial institucional.
2. Un alumno puede registrar varios números telefónicos.
3. Un alumno puede inscribirse en varias materias.
4. Cada materia es impartida por un solo profesor.
5. Un profesor pertenece únicamente a un departamento.
6. Un profesor puede participar en varios proyectos de investigación.
7. Un profesor puede registrar varios dependientes.
...
![Ejercicio 7 Relacional](img/Ejercicio7ModeloRelacional.png)
